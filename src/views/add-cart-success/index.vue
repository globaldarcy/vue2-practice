            ...
            <div class="goods">
                <div class="left-good">
                    ...
                    <div class="right-info">
                        ...
                        <p class="attr">颜色：{{ skuInfo.skuSaleAttrValueList[0].saleAttrValueName }}/{{ skuInfo.skuSaleAttrValueList[1].saleAttrValueName }} 数量：{{ $route.query.skuNum }}</p>
                    </div>
                </div>
                <div class="right-gocart">
                    ...
                    <router-link to="/shop-cart">去购物车结算 ></router-link>
