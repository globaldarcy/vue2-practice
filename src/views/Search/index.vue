...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapMutations('home', ['clearKeyword']),
            rmCategoryName() {
                // console.log(JSON.stringify(this.searchParams));
                // this.searchParams = { ...this.searchParams, ...{ category1Id: undefined, category2Id: undefined, category3Id: undefined, categoryName: undefined } };
        ...
        watch: {
            $route: {
                ...
                handler() {
                    ...
                    // console.log(JSON.stringify(this.searchParams));
                    this.getSearchList(this.searchParams);
                    this.searchParams = { ...this.searchParams, ...{ category1Id: undefined, category2Id: undefined, category3Id: undefined } };
                    // console.log(JSON.stringify(this.searchParams));
                },
            },
        },
