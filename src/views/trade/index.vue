    ...
    <div class="trade-container">
        ...
        <div class="content">
            ...
            <div class="address clearFix" v-for="(address, index) in addressInfo" :key="index">
                <span class="username" :class="{ selected: +address.isDefault }">{{ address.consignee }}</span>
        ...
        <div class="trade">
            ...
            <div class="receiveInfo">
                ...
                收货人：<span>{{ defaultPerson.consignee }}</span>
                <span>{{ defaultPerson.phoneNum }}</span>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            defaultPerson() {
                /* let result =  this.addressInfo.filter((item) => {
