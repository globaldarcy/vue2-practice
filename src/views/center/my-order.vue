    ...
    <div class="order-right">
        <div class="order-content">
                        ...
                        <tr v-for="(item, index) in order.orderDetailList" :key="item.id">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="item.imgUrl" style="width: 80px" />
            ...
            <div class="choose-order">
                <Pagination :pageNo="page" :pageSize="limit" :total="orderList.total" :continues="5" @getPageNo="getPageNoHandler"></Pagination>
